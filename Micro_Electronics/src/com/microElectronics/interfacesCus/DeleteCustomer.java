...
public class DeleteCustomer extends JInternalFrame {
	...
	public DeleteCustomer() {
		...
		JLabel lblCustomerForm = new JLabel("Delete Customers");
		lblCustomerForm.setBounds(430, 25, 307, 25);
		...
		textFieldCusName.setBounds(152, 117, 135, 20);
		...
		textFieldSearch.setBounds(970, 31, 154, 20);
