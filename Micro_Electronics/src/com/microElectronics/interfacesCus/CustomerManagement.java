...
public class CustomerManagement extends JFrame {
	...
	public CustomerManagement() {
		...
		JLabel lblEmployeeManagement = new JLabel("Customer Management");
		...
		JButton btnWarranty = new JButton("Report");
				...
				btnWarranty.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
							...
							try {
					            ...
					            String report = "C:\\Users\\User\\Desktop\\SLIIT\\Micro Electronics\\src\\itp\\java\\report\\payment\\reportCustomer.jrxml";
